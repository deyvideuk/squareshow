...
<li>
    <button id="botaoPublicarObras">Pubblicare opere</button>
</li>
...
<script>
    ...
    if(typeof botaoConta == "undefined"){
        ...
        <?php endif;?>
        var botaoPublicarObras =document.querySelector("#botaoPublicarObras");
    }else{
        ...
        <?php if($_SESSION['categoria'] == "Admin"):?>
            var botaoGerenciarUsuarios = document.querySelector("#botaoGerenciarUsuarios");
        <?php endif;?>
        botaoPublicarObras =document.querySelector("#botaoPublicarObras");
    }
...
<script>
    ...
    <?php if($_SESSION['categoria'] == "Admin"):?>
        botaoGerenciarUsuarios.removeAttribute("class", "selected");
    <?php endif;?>
    botaoPublicarObras.removeAttribute("class", "selected");
    ...
    $("#botaoPublicarObras").click(()=>{
        $("#print-perfil").load("pags/perfil/publicarObras.php");
    });
